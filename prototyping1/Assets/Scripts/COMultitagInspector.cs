...
[CustomEditor(typeof(COMultitag))]
public class COMultitagInspector : Editor
{
    private COMultitag tagObj = null;
    ...
    private void TagEdit(Rect rect, int index, bool isActive, bool isFocused)
    {
        ...
        var tagList = COTags.AllTags.ToList();
        ...
        else
        {
            ...
            {
                COTags.AddTags(new List<string>{tagObj.Tags[index]});
            }
        }
