...
public class KennyMecham_ShootingEnemy : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    player = COTags.FindGameObjectsWithTag("Player")[0].transform;
  ...
  void Update()
  {
    if (player != null)
    {
      ...
      if (timeBtwShots <= 0)
      {
        ...
        var reflectableProj = newProj.GetComponent<KennyMecham_ReflectableAttackBase>();
        reflectableProj.Attack(gameObject, player.gameObject);
        timeBtwShots = startTimeBtwShots;
      }
      else
      {
